...
#                    packed = output_qty
                if mrp_line_rec.workorder_code == 'rmc':
                    ...
                    rmcq = output_qty
                elif mrp_line_rec.workorder_code == 'unpacked':
                    unpacked = output_qty
                elif mrp_line_rec.workorder_code == 'semipacked':
                    semipacked = output_qty
                elif mrp_line_rec.workorder_code == 'packed':
                    packed = output_qty
                
                
                mrp_line_rec.production_id.product_id.write({'semipacked': semipacked,'packed': packed,'unpacked': unpacked,'rmqc': rmcq,'rmc': raw_count})
    ...
    def get_close_wiz(self):
        ...
        if active_id:
            ...
            res = mrp_line_rec.write({'state': 'startworking'})
        return {
